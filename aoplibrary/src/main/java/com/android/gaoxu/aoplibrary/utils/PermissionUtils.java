...
public class PermissionUtils {
    ...
    public interface FullCallback {
        ...
        void onDenied(String[] failedPermissions);
    }
    ...
    public static class FragmentCallback extends Fragment {
        private FullCallback mCallback;
        ...
        public void setResult(FullCallback callback) {
            mCallback = callback;
        }
                ...
                if (result) {
                    ...
                    if (SystemClock.elapsedRealtime() - mRequestTime < 300) {
                        ...
                        for (String permission : mPermissions) {
                            if (!PermissionUtils.checkPermission(getActivity(), permission)) {
                        ...
                        mCallback.onDenied(mPermissions);
                    }
                }
            }
        }
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == REQUEST_CODE) {
                if (mCallback != null && mPermissions != null) {
                    ...
                    if (result) {
                        ...
                        mCallback.onDenied(list.toArray(failed));
                    }
                }
            }
        }
     ...
     * @return 请求权限工具对象
     */
    public static PermissionUtils getInstance(FragmentActivity activity) {
     ...
     * @return 返回自身链式编程
     */
    public PermissionUtils request(@Permission String... permissions) {
     ...
     */
    public void callback(FullCallback callback) {
        ...
        if (fragmentByTag != null) {
            ...
            mFragmentCallback.setResult(callback);
        } else {
    ...
    private void requestPermission() {
        ...
        if (mActivity.getSupportFragmentManager().findFragmentByTag(tag) == null) {
            throw new ReflectException(mActivity.getString(R.string.permission_request_exception));
        }
